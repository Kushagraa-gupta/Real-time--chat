...
exports.createOrGetConversation = exports.getConversations = void 0;
...
const getConversations = async (req, res, next) => {
    try {
        ...
        const conversationsWithUnread = await Promise.all(conversations.map(async (chat) => {
...
const createOrGetConversation = async (req, res, next) => {
    try {
        ...
        const validatedData = validators_1.createConversationSchema.parse(req.body);
        ...
        if (isGroup) {
            ...
            const existingConversations = await prisma_1.prisma.conversation.findFirst({
                where: {
                    isGroup: false,
                    AND: [
                        {
